...
Player.prototype.tweetNowPlaying = function() {
    ...
    window.open("https://twitter.com/intent/tweet?related=player_vas3k_ru&text=Слушаю%20сейчас:%20" + track.artist + "%20—%20" + track.title + "%20http://player.vas3k.ru/small%23track:" + track.id + "%20@player_vas3k_ru",
                "Твитнуть трек",
